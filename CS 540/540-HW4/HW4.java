...
public class HW4{
	...
	*/
	public static void main(String[] args)
	{
		...
		NNImpl2 nn=new NNImpl2(trainingSet,Integer.parseInt(args[0]),Double.parseDouble(args[1]),Integer.parseInt(args[2]), 
		...
		for(int i=0;i<testSet.size();i++)
		{
			...
			{
				System.out.println("correctly guessed " + outputs[i]);
				correct++;
			} else {
